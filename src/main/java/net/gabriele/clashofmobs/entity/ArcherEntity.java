...
public class ArcherEntity extends AbstractSkeleton {
    protected ArcherEntity(EntityType<? extends AbstractSkeleton> p_32133_, Level p_32134_) {
        super(p_32133_, p_32134_);
    }
    public static AttributeSupplier.Builder createAttributes()
    {
        return Monster.createMonsterAttributes().
                add(Attributes.MAX_HEALTH, 44f).
    ...
    public void performRangedAttack(LivingEntity p_32141_, float p_32142_) {
        ...
        abstractarrow.setBaseDamage(22f);
